  ...
  ea: {
    ...
    body: `
      ...
      <div class="cs-section">
        ...
        <div class="funnel-note">Illustrative shape only, scoped to the whole webstore, not Battlefield. Not an export of real EA analytics. Exact percentage for the mobile gap withheld to keep EA's internal metrics private. The confirmed number is the 10% increase in checkout revenue captured.</div>
      </div>
