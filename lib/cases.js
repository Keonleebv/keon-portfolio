  ...
  coddle: {
    ...
    body: `
      ...
      <div class="cs-section">
        ...
        <table class="cs-table">
          <tr><th>Decision</th><th>Why</th></tr>
          <tr><td>Rebrand: Nourish &rarr; Coddle</td><td>Storage keys migrated cleanly on first launch, domain and bundle ID moved with it.</td></tr>
          ...
          <tr><td>Session replay: deferred, then un-deferred</td><td>First shipped without it after a wrong diagnosis of a dependency conflict. Re-enabled with zero new dependencies once that was corrected.</td></tr>
          <tr><td>Individual Apple Developer account for now</td><td>A co-founder can't yet be added as an internal tester. Fixable by forming an LLC, deliberately deferred to public launch.</td></tr>
        </table>
      </div>
