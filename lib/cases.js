export const CASES = {
  ...
  // Disclosure boundary, deliberate: the 10% checkout-revenue figure below is the
  // public-safe expression of a dollar amount that stays off this site, and the
  // mobile conversion gap is a separate metric that is withheld outright. The
  // resume states both in full because it goes to individual recruiters, not the
  // open web. If the two ever look inconsistent, the site is the one that's right.
  ea: {
